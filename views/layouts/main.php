...
<header id="header">
    ...
    if (Yii::$app->user->isGuest){
        ...
        Yii::$app->user->identity->administrator == 1 ?
            ($items = [
...
index']],
            ...
            ($items = [
                ...
                ['label' => 'О нас', 'url' => ['/site/about']],
                ['label' => 'Где нас найти', 'url' => ['/site/contact']],
                ['label' => 'Корзина', 'url' => ['/cart/index?CartSearch[id_user]='.Yii::$app->user->identity->id_u]],
    ...
    NavBar::begin([
        ...
        'brandLabel' => Html::img('/web/logo/logo.png', ['style' => 'height: 40px']),
